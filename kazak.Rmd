...
venn.diagram(x, "sr_DESeq_edgeR.tiff", fill = brewer.pal(4, "BuGn"))

x <- vennGen(up.sen.des, dn.sen.des, up.sen.edge, dn.sen.edge)
venn.diagram(x, "sen_DESeq_edgeR.tiff", fill = brewer.pal(4, "OrRd"))

x <- vennGen(up.untr.des, dn.untr.des, up.untr.edge, dn.untr.edge)
venn.diagram(x, "Untr_DESeq_edgeR.tiff", fill = brewer.pal(4, "BuPu"))
```
