...
```{r PCAallGene, fig.width = 6, fig.height = 5}
...
In total, there are **`r nrow(res.sig)`** statistically significant differentially expressed genes between **SR_treated and SR_untreated**
